...
export class ItemsResolver {
  ...
  async addStatusItems(
    ...
    @Args({ type: () => [String], name: 'itemIds', description: 'Идентификаторы позиций' }) itemIds: string[],
  ...
  async changeSellingPriceItem(
    @CurrentUser() user: User,
    @Args({ type: () => String, name: 'itemId', description: 'Идентификатор позиции' }) itemId: string,
