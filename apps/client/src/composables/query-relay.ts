...
import type { DocumentParameter, OptionsParameter, UseQueryReturn } from '@vue/apollo-composable/dist/useQuery.d.ts'
import type { UseResultReturn } from '@vue/apollo-composable/dist/useResult.d.ts'
import type { ExtractSingleKey } from '@vue/apollo-composable/dist/util/ExtractSingleKey.d.ts'
import { InvariantError } from 'ts-invariant'
import { useQuery } from '@vue/apollo-composable'
import { useEventListener } from '@vueuse/core'

import type { PageInfo, PaginationInterface } from '@repo/queries/types/pagination.ts'

import type { VT } from '@/shared/utils/graphql-relay'
...
export type QueryRelayParams<TResult = any, TVariables extends OperationVariables = any> = {
...
>(
  ...
  const getMutationResult = <TResultMutation>(
    result: Omit<FetchResult<TResultMutation, Record<string, unknown>, Record<string, unknown>>, 'context'>,
